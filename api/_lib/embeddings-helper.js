const { getEmbedding, calculateHash } = require("./gemini-embeddings");
const { randomUUID } = require("crypto");

async function saveEmbedding(sql, userId, ownerId, ownerType, category, description, amountMinor, date, platform) {
  let currency = "USD";
  try {
...
async function deleteEmbedding(sql, ownerId, ownerType) {
  try {
    await sql`
