...
export function AssistantPanel({ currentUser }: AssistantPanelProps) {
  ...
  return (
    <>
      ...
      {/* Chat Panel */}
      {isOpen && (
        <div className="fixed bottom-24 right-4 left-4 w-auto h-[520px] md:left-auto md:right-6 md:w-96 md:h-[580px] lg:bottom-24 lg:right-6 z-40 flex flex-col overflow-hidden rounded-[28px] border border-white/60 bg-white/90 shadow-[0_30px_80px_rgba(40,44,35,0.18)] backdrop-blur-2xl transition-all duration-300">
